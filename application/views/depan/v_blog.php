                    ...
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('blog'); ?>">Tulisan</a>
                                </li>
                                <li class="nav-item">
    ...
    <section class="blog-wrap">
        <div class="container">
            <div class="row">
                    ...
                    <?php foreach ($data->result() as $row): ?>
                        <div class="blog-single-item">
                            ...
                            <div class="blog-tiltle_block">
                                <h4><a
                                        href="<?php echo site_url('tulisan/' . $row->tulisan_slug); ?>"><?php echo $row->tulisan_judul; ?></a>
                                </h4>
                                <h6> <a href="#"><i class="fa fa-user"
                                            aria-hidden="true"></i><span><?php echo $row->tulisan_author; ?></span> </a> | <a
                                ...
                                <div class="blog-icons">
                                    <div class="blog-share_block">
                                        <a href="<?php echo site_url('tulisan/' . $row->tulisan_slug); ?>">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    <form action="<?php echo site_url('tulisan/search'); ?>" method="get">
                    ...
                    <div class="blog-category_block">
                        ...
                        <ul>
                            <?php foreach ($category->result() as $row): ?>
                                <li><a
                                        href="<?php echo site_url('tulisan/kategori/' . str_replace(" ", "-", $row->kategori_nama)); ?>"><?php echo $row->kategori_nama; ?><i
                    ...
                    <div class="blog-featured_post">
                        ...
                        <?php foreach ($populer->result() as $row): ?>
                            <div class="blog-featured-img_block">
                                ...
                                <h5><a
                                        href="<?php echo site_url('tulisan/' . $row->tulisan_slug); ?>"><?php echo limit_words($row->tulisan_judul, 3) . '...'; ?></a>
                                </h5>
