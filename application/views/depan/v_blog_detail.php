                                                        ...
                                                        <div class="blodpost-tab-img"
                                                            ...
                                                            <center>
                                                                <h2 style="padding-top:20%;color:#fff;">
                                                                    <?php echo substr($row->komentar_nama, 0, 1); ?></h2>
                                                            </center>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-10">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <div class="blodpost-tab-img"
                                                                ...
                                                                <center>
                                                                    <h2 style="padding-top:20%;color:#fff;">
                                                                        <?php echo substr($res->komentar_nama, 0, 1); ?></h2>
                                                                </center>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-9">
                    ...
                    <div class="blog-category_block">
                        ...
                        <ul>
                            <?php foreach ($category->result() as $row): ?>
                                <li><a
                                        href="<?php echo site_url('blog/kategori/' . str_replace(" ", "-", $row->kategori_nama)); ?>"><?php echo $row->kategori_nama; ?><i
                    ...
                    <div class="blog-featured_post">
                        ...
                        <?php foreach ($populer->result() as $row): ?>
                            <div class="blog-featured-img_block">
                                ...
                                <h5><a
                                        href="<?php echo site_url('artikel/' . $row->tulisan_slug); ?>"><?php echo limit_words($row->tulisan_judul, 3) . '...'; ?></a>
                                </h5>
