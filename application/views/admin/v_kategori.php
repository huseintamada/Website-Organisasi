...
<head>
  ...
  <title>KMIK JAKARTA | Kategori Berita</title>
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="<?php echo base_url() . 'admin/tulisan/add_tulisan' ?>"><i class="fa fa-thumb-tack"></i> Post
                  Berita</a></li>
              <li class="active"><a href="<?php echo base_url() . 'admin/kategori' ?>"><i class="fa fa-wrench"></i>
                  Kategori</a></li>
            </ul>
          </li>
          <li>
              ...
              <div class="box">
                <div class="box-header">
                  <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span
                      class="fa fa-plus"></span> Add Kategori</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
