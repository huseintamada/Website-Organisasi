...
<head>
  ...
  <title>KMIK JAKARTA | Data Pengurus</title>
              ...
              <div class="box">
                <div class="box-header">
                  <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span
                      class="fa fa-plus"></span> Tambah Pengurus</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
      ...
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'admin/siswa/simpan_siswa' ?>" method="post"
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="inputUserName" class="col-sm-4 control-label">Daerah</label>
              <div class="col-sm-7">
                <input type="text" name="xnis" class="form-control" id="inputUserName" placeholder="Daerah" required>
              </div>
            </div>
